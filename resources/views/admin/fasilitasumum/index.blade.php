        ...
        <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face1.jpg') }}"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face2.jpg') }}"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face3.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face4.jpg') }}"
                                        alt="image"><span class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face5.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('assets-admin/images/faces/face6.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#kejadian-bencana" aria-expanded="false"
                            aria-controls="kejadian-bencana">
                            <i class="icon-layout menu-icon"></i>
                            <span class="menu-title">Kejadian Bencana</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="kejadian-bencana">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('kejadian-bencana.index') }}">Lihat Data</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('kejadian-bencana.create') }}">Tambah Data</a>
                                </li>
                            </ul>
                        </div>
                    </li> --}}
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="{{ asset('assets-admin/images/dashboard/people.svg') }}"
                                        alt="people">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright
                            © 2021.
                            Premium <a href="https://www.bootstrapdash.com/" target="_blank">Bootstrap
                                admin

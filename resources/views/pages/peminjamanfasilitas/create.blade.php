                        ...
                        <form action="{{ route('peminjaman.store') }}" method="POST" id="peminjamanForm" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="fasilitas_id" class="form-select @error('fasilitas_id') is-invalid @enderror" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="tujuan" class="form-control @error('tujuan') is-invalid @enderror"
                                          rows="3" placeholder="Masukkan tujuan peminjaman fasilitas" required>{{ old('tujuan') }}</textarea>
                                @error('tujuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @error('total_biaya')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted mt-1">Biaya akan otomatis terisi saat memilih fasilitas</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border mb-4">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0"><i class="bi bi-images me-2"></i>Upload Media/Dokumen Pendukung</h6>
                                    <small class="text-muted">Upload surat permohonan, KTP, atau dokumen pendukung lainnya</small>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Format: PDF, JPG, PNG, DOC (Max: 5MB per file)</small>
                                    ...
                                    <div class="alert alert-info mt-3">
                                        ...
                                        <small>
                                            Anda bisa upload maksimal 5 file sekaligus. Dokumen pendukung akan langsung tersimpan bersama data peminjaman.
                                        </small>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3 text-center">
                            ...
                            <p class="text-muted small mb-3">Anda bisa langsung upload dokumen pendukung bersamaan dengan data peminjaman</p>
                        </div>
                ...
                if (mediaInput && mediaInput.files.length > 0) {
                    ...
                    for (let i = 0; i < mediaInput.files.length; i++) {
                        if (mediaInput.files[i].size > maxSize) {
                            e.preventDefault();
                            alert(`File "${mediaInput.files[i].name}" melebihi 5MB. Mohon kompres atau pilih file lain.`);
                            return false;
                        }
                    }

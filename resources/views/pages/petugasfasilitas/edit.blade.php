        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('petugas-fasilitas.show', $petugasFasilitas->getKey()) }}">
                            Detail
                        </a>
                    </li>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        {{-- FORM --}}
                        <form
                            action="{{ route('petugas-fasilitas.update', $petugasFasilitas->getKey()) }}"
                            method="POST"
                        >
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card bg-light mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">
                                        Alamat: {{ $petugasFasilitas->warga->alamat ?? '-' }}
                                    </p>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                $isLainnya = !in_array($currentPeran, $defaultRoles);
                            @endphp
                            ...
                            <div class="d-flex justify-content-between border-top pt-3">
                                <div>
                                    <a
                                        href="{{ route('petugas-fasilitas.show', $petugasFasilitas->getKey()) }}"

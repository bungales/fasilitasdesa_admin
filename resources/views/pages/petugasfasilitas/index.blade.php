                        ...
                        @forelse ($petugasFasilitas as $item)
                            <tr class="{{ $loop->odd ? 'row-pink' : 'row-blue' }}">
                                <td class="text-center fw-bold">
                                    {{ $loop->iteration + ($petugasFasilitas->currentPage() - 1) * $petugasFasilitas->perPage() }}
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        {{-- SHOW --}}
                                        <a href="{{ route('petugas-fasilitas.show', ['petugas_fasilita' => $item->getKey()]) }}"
                                        ...
                                        {{-- EDIT --}}
                                        <a href="{{ route('petugas-fasilitas.edit', ['petugas_fasilita' => $item->getKey()]) }}"
                                        ...
                                        {{-- DELETE --}}
                                        <form action="{{ route('petugas-fasilitas.destroy', ['petugas_fasilita' => $item->getKey()]) }}"
                                              method="POST"
